...
macro(serious_proton2_executable EXECUTABLE_NAME)
    ...
    target_link_libraries(${EXECUTABLE_NAME} PUBLIC box2d bullet lua json11 sp2freetype)
    ...
    target_link_libraries(${EXECUTABLE_NAME} PUBLIC ${SDL2_LIBRARIES} ${ZLIB_LIBRARIES})
    target_include_directories(${EXECUTABLE_NAME} PUBLIC ${SDL2_INCLUDE_DIRS} ${ZLIB_INCLUDE_DIR})
    if(WIN32)
        target_link_libraries(${EXECUTABLE_NAME} PUBLIC dbghelp psapi ws2_32 iphlpapi ole32 strmiids)
        if (CMAKE_BUILD_TYPE STREQUAL "Debug")
            target_link_libraries(${EXECUTABLE_NAME} PUBLIC "-mconsole")
        endif()
    endif()
    if(UNIX)
