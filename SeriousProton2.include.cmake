...
if (EMSCRIPTEN)
    set(EMSCRIPTEN_FLAGS "-s USE_SDL=2 -fno-exceptions -Wno-c++17-extensions")
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${EMSCRIPTEN_FLAGS}")
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${EMSCRIPTEN_FLAGS}")
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -s ALLOW_MEMORY_GROWTH=1 -lidbfs.js")
    ...
    if ("${SDL2_LIBRARIES}" STREQUAL "SDL2::SDL2main;SDL2::SDL2")
        set(SDL2_LIBRARIES SDL2::SDL2)
    endif()
...
macro(serious_proton2_executable EXECUTABLE_NAME)
    ...
    if(WIN32)
        if (SP2_SINGLE_EXECUTABLE)
            ...
            foreach(RESOURCE_PATH ${SP2_RESOURCE_PATHS})
                install(DIRECTORY "${RESOURCE_PATH}" DESTINATION ${CMAKE_CURRENT_BINARY_DIR}/)
            endforeach()
        endif()
    elseif(EMSCRIPTEN)
        install(TARGETS ${SP2_TARGET_NAME} RUNTIME DESTINATION .)
