...
macro(serious_proton2_executable EXECUTABLE_NAME)
    ...
    target_link_libraries(${SP2_TARGET_NAME} PUBLIC SDL2::SDL2 ${ZLIB_LIBRARIES})
    target_include_directories(${SP2_TARGET_NAME} PUBLIC ${SDL2_INCLUDE_DIRS} ${ZLIB_INCLUDE_DIR})
    if(WIN32)
        target_link_libraries(${SP2_TARGET_NAME} PUBLIC dbghelp psapi ws2_32 iphlpapi ole32 strmiids)
